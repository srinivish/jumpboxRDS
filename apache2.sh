...
# check and print apache2 version
echo "Apache version" | systemd-cat -t startup_script -p 4
apache2 -v | systemd-cat -t startup_script -p 4

# check and print apache2 status
echo "Apache status" | systemd-cat -t startup_script -p 4
sudo systemctl status apache2 | systemd-cat -t startup_script -p 4
